...
public class App114 {
  public static void main(String[] args){
    ...
    hashMap.put("1", new Student("2021050421", "Pham Van Luong", "C2"));
    hashMap.put("2", new Student("2021050885", "Nguyen Thuy Trang", "E1"));
    hashMap.put("3", new Student("2021050418", "Tran Tien Luc", "C2"));
    hashMap.put("4", new Student("2021050415", "Nguyen Thanh Luan", "C2"));
