...
public class App112{
  public static void main(String[] args) {
    ...
    Student student1 = new Student("Luong", 9);
    Student student2 = new Student("Luan", 2);
    Student student3 = new Student("Luc", 5);
    Student student4 = new Student("Minh", 10); 
    Student student5 = new Student("Manh", 10); 
